...
/* Stolen from linux kernel 2.6.14.5
 */
...
#define PM2R_DMA_ADDRESS				0x0028
#define PM2R_DMA_COUNT					0x0030
...
#define PM2R_WAIT_FOR_COMPLETION			0x8088
#define PM2R_PACKED_DATA_LIMITS				0x8150
#define PM2R_SCISSOR_MODE				0x8180
#define		PM2R_SCISSOR_MINXY		GLINT_TAG_ADDR(0x03,0x01)
#define		PM2R_SCISSOR_MAXXY		GLINT_TAG_ADDR(0x03,0x02)
...
#define	PM2R_CONSTANT_COLOR		GLINT_TAG_ADDR(0x0f,0x0d)
...
#define PM2R_TEXTURE_DATA				0x88e8
#define PM2R_TEXTURE_DOWNLOAD_OFFSET			0x88f0
...
#define PM2R_FB_COLOR					0x8a98
#define PM2R_FB_DATA					0x8aa0
...
#define PM2F_RENDER_SYNC_ON_HOST			(1<<12)
#define PM2F_RENDER_XPOSITIVE				(1<<21)
#define PM2F_RENDER_YPOSITIVE				(1<<22)
...
#define PM2F_FB_READ_SOURCE_ENABLE			0x0200 /* 1 << 9 */
#define PM2F_FB_READ_DEST_ENABLE			0x0400 /* 1 << 10 */
#define PM2F_FB_PACKED					(1 << 19)
