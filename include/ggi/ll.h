...
******************************************************************************
   ...
   Copyright (c) Tue Mar 18 2002 by:
        Brian S. Julin          bri@tull.umassp.edu
        Christoph Egger         Christoph_Egger@t-online.de


This software may be redistributed under the terms of the GNU Library
(a.k.a. "Lesser") Public License -- see the file COPYING in the parent
