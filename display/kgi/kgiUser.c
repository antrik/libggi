...
mig_external kern_return_t kgi_set_images
(
	io_t io_object,
	int images
)
{
	...
	auto const mach_msg_type_t imagesType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
mig_external kern_return_t kgi_set_image_mode
(
	io_t io_object,
	int image,
...
)
{
	...
	auto const mach_msg_type_t imageType = {
		/* msgt_name = */		2,
		/* msgt_size = */		32,
		/* msgt_number = */		1,
		/* msgt_inline = */		TRUE,
...
mig_external kern_return_t kgi_get_image_mode
(
	io_t io_object,
	int image,
	kgi_image_mode_t *mode
...
#if	TypeCheck
	if (BAD_TYPECHECK (&OutP->modeType, &modeCheck))
		return MIG_TYPE_ERROR;
#endif	/* TypeCheck */
...
mig_external kern_return_t kgi_check_mode
(
	io_t io_object
)
{
...
mig_external kern_return_t kgi_set_mode
(
	io_t io_object
)
{
...
mig_external kern_return_t kgi_unset_mode
(
	io_t io_object
)
{
...
mig_external kern_return_t kgi_get_fb_resource
(
	io_t io_object,
...
)
{
	...
	auto const mach_msg_type_t fbCheck = {
		/* msgt_name = */		8,
		/* msgt_size = */		8,
		/* msgt_number = */		96,
		/* msgt_inline = */		TRUE,
...
#if	TypeCheck
	if (BAD_TYPECHECK (&OutP->fbType, &fbCheck))
		return MIG_TYPE_ERROR;
#endif	/* TypeCheck */
...
mig_external kern_return_t kgi_setup_mmap_fb
(
	io_t io_object
)
{
